...
let store = createStore({
    state: {
        ...
        player: {
            player_state: 2,   // 1 - Attack, 2 - Defend, 3 - throw up ?
        ...
        cards_on_bot: [
            {card_rank: 4, card_suit: "hearts", card_height: 120, card_index: 1},
            // {card_rank: 4, card_suit: "hearts", card_height: 120, card_index: 2},
            // {card_rank: 4, card_suit: "hearts", card_height: 120, card_index: 3},
            // {card_rank: 4, card_suit: "hearts", card_height: 120, card_index: 0},
            // {card_rank: 4, card_suit: "hearts", card_height: 120, card_index: 4},
            // {card_rank: 4, card_suit: "hearts", card_height: 120, card_index: 5},
            // {card_rank: 4, card_suit: "hearts", card_height: 120, card_index: 6},
        ],
        cards_on_top: [
            // {card_rank: 5, card_suit: "hearts", card_height: 120, beaten: true, card_index: 0},
            // {card_rank: 6, card_suit: "hearts", card_height: 120, beaten: true, card_index: 1},
            ...
            // {card_rank: 5, card_suit: "hearts", card_height: 120, beaten: true, card_index: 4},
            // {card_rank: 5, card_suit: "hearts", card_height: 120, beaten: true, card_index: 5},
